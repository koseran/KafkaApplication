        ...
        try (Producer<String, Task> producer = new KafkaProducer<>(properties)) {
            for (int i = 0; i < 20; i++) {
                ...
                try {
                   ...
                   // ProducerRecord<String, Task> record = new ProducerRecord<>("task.events1",i % 6, null, task);
                    ProducerRecord<String, Task> record = new ProducerRecord<>("taskPartition",i % 6,null, task);
